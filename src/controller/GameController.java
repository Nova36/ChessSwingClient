...
import edu.neumont.learningChess.comm.BoardState;
import edu.neumont.learningChess.comm.JSONFactory;


public class GameController implements ChessBoardInterface, ICheckChecker, IListener {
	...
	private void castleHandleLargeSide(Move move) {
		...
		if (!board.getPiece(move.getFrom()).hasMoved()
			...
			if (!inCheck) {
				...
				board.makeMove(new Move(rook.getLocation(board), new Location(rook
						.getLocation(board).getRow(), 3)));
			}
		}
	}
		...
		if (board.hasEnPassantMove()) {
			...
			if (adjPawnRight != null && adjPawnRight.getTeam() != currentPlayer) {
				if (adjPawnRight instanceof Pawn) {
					Location adjPawnLoc = adjPawnRight.getLocation(board);
				...
				if (adjPawnLeft instanceof Pawn) {
					Location adjPawnLoc = adjPawnLeft.getLocation(board);
					if (to.getColumn() == adjPawnLoc.getColumn()) {
	...
	public boolean canMove(Team team) {
		...
		for (Iterator<ChessPiece> i = team.getPieces(); !canMove && i.hasNext();) {
			...
			for (Enumeration<Location> e = piece.getLegalMoves(board); !canMove
				...
				// Apply the move
				board.tryMove(new Move(piece.getLocation(board), to));
	...
	@Override
	public boolean isInCheck(Team arg0) {
	...
	@Override
	public ChessPiece getPiece(Location arg0) {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public Location getPieceLocation(ChessPiece arg0) {
		// TODO Auto-generated method stub
		return null;
	}
	...
	@Override
	public void hasEnPassantMove(boolean arg0) {
		// TODO Auto-generated method stub
		
	}

	@Override
	public void hasEnPassantMove(boolean arg0, Location arg1) {
		// TODO Auto-generated method stub
		
	}

	@Override
	public boolean hasPiece(Location arg0) {
		// TODO Auto-generated method stub
		return false;
	}

	@Override
	public boolean hasPiece(Location arg0, boolean arg1) {
		// TODO Auto-generated method stub
		return false;
	}

	@Override
	public boolean isEnPassantableLocation(Location arg0) {
		// TODO Auto-generated method stub
		return false;
	}

	@Override
	public void makeMove(Move arg0) {
		// TODO Auto-generated method stub
		
	}

	@Override
	public void placePiece(ChessPiece arg0, Location arg1) {
		// TODO Auto-generated method stub
		
	}

	@Override
	public boolean rangeIsEmpty(Location arg0, Location arg1) {
		// TODO Auto-generated method stub
		return false;
	}

	@Override
	public void removePiece(ChessPiece arg0, Location arg1) {
		// TODO Auto-generated method stub
		
	}

	@Override
	public void tryMove(Move arg0) {
		// TODO Auto-generated method stub
